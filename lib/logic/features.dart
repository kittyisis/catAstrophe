...
@Injectable()
class FeatureAppShowcase extends _Feature {
  String _titleSpan;
  List<String> _featuresList;
  String _photo;

  //titleSpan for header two
  String get titleSpan => this._titleSpan;
  set titleSpan(String titleSpan) {
    this._titleSpan = titleSpan;
  }

  //featuresList
  List<String> get featuresList => this._featuresList;
  set featuresList(List<String> featuresList) {
